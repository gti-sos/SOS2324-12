            ...
            <Col sm="12" md="6">
                <Card>
                    ...
                    <CardBody>
                        <CardSubtitle>
                            <ul>
                                <li><a href="https://github.com/josmarsua">José Martínez Suárez</a></li>
                                <li><a href="https://github.com/borfloave">Borja Flores Avecilla</a></li>
                                <li><a href="https://github.com/josmenrue">José Joaquín Mena-Bernal Rueda</a></li>
                            </ul>
                        </CardSubtitle>
                    </CardBody>
                </Card>
            ...
            <Col sm="12" md="4">
                <Card>
                    ...
                    <CardBody>
                        <CardSubtitle>
                            <ul>
                                <li><a href="https://www.youtube.com/watch?v=POnQayIuebA">Ir al vídeo</a></li>
                            </ul>
                        </CardSubtitle>
                    </CardBody>
                </Card>
